...
import { getUserDetails } from '../context/github/GithubActions'
...
const User = () => {
	...
	useEffect(() => {
		...
		const getUserData = async () => {
			const userData = await getUserDetails(params.login)
			dispatch({ type: 'GET_USER_DETAILS', payload: userData })
		}
